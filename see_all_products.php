                                    ...
                                    <div id="dataTable3_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        ...
                                        <thead class="text-capitalize" style="background: linear-gradient(90deg, rgba(4,2,11,1) 0%, rgba(27,0,255,1) 54%, rgba(6,1,6,1) 97%);">
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" style="width: 143px;" aria-label="Office: activate to sort column ascending">Category</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" style="width: 86px;" aria-label="Age: activate to sort column ascending">Sub-Category</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" style="width: 162px;" aria-label="Start Date: activate to sort column ascending">In Stock</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" style="width: 122px;" aria-label="salary: activate to sort column ascending">Price</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable3" rowspan="1" colspan="1" style="width: 122px;" aria-label="salary: activate to sort column ascending">Sold</th>
                                            </tr>
                                        </thead>
                                        <tbody>  
                                        <tr role="row" class="odd">
                                                <td tabindex="0" class="sorting_1">Coca Cola</td>
                                                <td class="">1234567890456</td>
                                                <td class="">Beverages</td>
                                                <td class="">Soft Drink</td>
                                                <td class="">2000</td>
                                                <td class="">$60</td>
                                                <td class="">1880</td>
                                            </tr><tr role="row" class="even">
                                                <td tabindex="0" class="sorting_1">Hilite</td>
                                                <td class="">234567898765456</td>
                                                <td class="">Tobbacco & Accessories</td>
                                                <td class="">Ciggarettes</td>
                                                <td class="">10000</td>
                                                <td class="">$140</td>
                                                <td class="">2000</td>
                                            </tr><tr role="row" class="odd">
                                                <td tabindex="0" class="sorting_1">Gold Leaf</td>
                                                <td class="">5678903937454</td>
                                                <td class="">Tobbacco & Accessories</td>
                                                <td class="">Ciggarettes</td>
                                                <td class="">50000</td>
                                                <td class="">$1400</td>
