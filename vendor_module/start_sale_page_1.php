...
<!-- nav end -->
    ...
    <div class="row justify-content-center">
        ...
        while($counter<sizeof($barcodes)){
            $imageQuery = "SELECT * FROM `Product`  where Barcode = '".$barcodes[$counter]."'";
            $resultPath = mysqli_query($conn,$imageQuery);
            $followingdata = $resultPath->fetch_assoc();
            $ImageToShow = $followingdata['ImagePath'];
            $ImageToShow = str_replace("/opt/lampp/htdocs/Freelance","..",$ImageToShow);
            $name = $followingdata['Product_Name'];

            $temp = '  
        <div class="col-md-3 col-sm-6 col-10 mt-3 mb-3 ml-3 mr-3 d-flex justify-content-center" style="/* text-align: center; */align-items: center;align-content: center;/* background-image: url(&quot;./images/start_sale_product_dummy.jpg&quot;); *//* background-size: contain; */">
            <div class="flip-box" style=" border: 0;">
                <div class="flip-box-inner">
                  ...
                  <div class="flip-box-back" style="background-image: linear-gradient(0deg, rgba(125,125,125,0.7861519607843137) 0%, rgba(4,0,0,0.6460959383753502) 100%), url('.$ImageToShow.') ; background-size: cover;border-radius: 17px;">
                    ...
                    <a href="start_sale_page_2.php?barcode='.$barcodes[$counter].'"> 
