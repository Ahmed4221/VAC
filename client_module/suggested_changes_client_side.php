...
if($_SESSION['ClientTemporaryloggedIn'] ){
    //   echo "Usertype is   : ",$_SESSION["UserType"];
            ...
            //   echo $email;
              $sql = "SELECT * FROM `Client` Where Approved = -1 and Email = '".$email."'";
              $query = mysqli_query($conn,$sql);
              $followingdata= $query->fetch_assoc();
              $fixed_percents = $followingdata['AgreedCommision'];
...
<!-- saved from url=(0072)file:///Users/rafayabbas/Documents/Personal/VAC/see_order_individual.php -->
  ...
  <title>Client Temporary Login</title>
...
<div class="my_custom_card">
  ...
  <div class="container">
    <div class="card_heading">
      <h3> Below is the amount of commision Percentage Suggested by Admin, please approve to continue with your account </h3>
    </div>
    <div class="row">
...
<label style="
    ...
    margin-right: 5vw;
"> Fixed Commision %</label>
    
          <input type="text" value = <?php echo $fixed_percents;echo" %"; ?> disabled="disabled" id="metric_name" class="form-control mb-4" name="new_metric" style="
    display: inline-block;
    width: 45%;
">

          
          <button  class="custom_button btn btn-success" id="default_img" onclick="location.href='ClientAcceptedCommision.php'"  style="
...
<button class="custom_button btn btn-danger" id="default_img" onclick="location.href='ClientRejectedCommision.php'" style="
