                          ...
                          <div class="data-tables datatable-dark">
                              <div id="dataTable3_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                 ...
                                 <tr role="row" class="odd">
                                          <td tabindex="0" class="sorting_1">111111</td>
                                          <td class="">3</td>
                                          <td class=""><span>4000</span>$</td>
                                          <td class="">46</td>
                                          ...
                                          <td tabindex="0" class="sorting_1">1111112</td>
                                          <td class="">3</td>
                                          <td class=""><span>1500</span>$</td>
                                          <td class="">12</td>
                                          <td class=""> <button class="btn btn-success custom_button" style="margin-right: 5px;" onclick="approved(this.parentNode.parentNode.children[0].innerText)">Confirm</button><button class="btn btn-danger custom_button" onclick="dissapproved(this.parentNode.parentNode.children[0].innerText)">Cancel</button></td>
                                         </tr><tr role="row" class="odd">
                                          <td tabindex="0" class="sorting_1">1111113</td>
                                          <td class="">3</td>
                                          <td class=""><span>2750</span>$</td>
                                          <td class="">20</td>
                                          <td class=""> <button class="btn btn-success custom_button" style="margin-right: 5px;" onclick="approved(this.parentNode.parentNode.children[0].innerText)">Confirm</button><button class="btn btn-danger custom_button" onclick="dissapproved(this.parentNode.parentNode.children[0].innerText)">Cancel</button></td>
                                         </tr></tbody>
...
<script>
  ...
  function approved(order_id) {
      window.location.href = (window.location.href.substring(0, window.location.href.lastIndexOf("/") + 1)) + "order_confirmed.php?" + order_id;
  }
  function dissapproved(order_id) {
      window.location.href = (window.location.href.substring(0, window.location.href.lastIndexOf("/") + 1)) + "order_canceled.php?" + order_id;
  }
  </script>
