        ...
        <div class="col-lg-12">
            <div class="main-box no-header clearfix">
                <div class="main-box-body clearfix">
                    <form enctype="multipart/form-data" method="post" action="file:///Users/rafayabbas/Documents/Personal/VAC/update_product_quantity.php">
<div class="table-responsive">
    ...
    padding-top: 8px;
">
                                        <input type="number" id="quantity" step="1" class="form-control mb-4" min="0" required="" placeholder="Add Quantity" name="product_quantity" style="
